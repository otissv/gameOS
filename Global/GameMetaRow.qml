...
id: root
    ...
    readonly property real contentWidth: showGenre && genretext.visible
    ...
    Item {
        ...
        anchors {
             left: playersCount.right; leftMargin: root.dividerSpacing
            verticalCenter: parent.verticalCenter
        }
    ...
    Text {
        ...
        height: parent.height
        anchors {
            left: ratingtext.right; leftMargin: root.dividerSpacing
